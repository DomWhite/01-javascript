...
//-------------------------------
// start rails server dish_api
//-------------------------------


var dish1 = new Dish ({ title: "test dish 1", starCount: 2});
var dish2 = new Dish ({ title: "test dish 2", starCount: 6});
...
dinner_menu.fetch().done(function() { //when data has been fetched run .each function
